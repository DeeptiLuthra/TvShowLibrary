...
namespace TvShowsLibrary
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            builder.RegisterType<TvShowsDbContext>().As<TvShowsDbContext>().InstancePerRequest();
            builder.RegisterType<TvShowsRepository>().As<ITvShowsRepository>().InstancePerRequest();
